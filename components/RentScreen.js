...
function RentScreen() {
  ...
  const handleRegisterRent = () => {
    ...
    setErrorMessage(
      `Alquiler de carro ${car.platenumber} por ${rentUsername} del ${rentStartDate} al ${rentEndDate} registrado correctamente.`
    );
    setSnackbarVisible(true);
  };
    ...
    <View style={styles.container}>
      ...
      <View style={styles.buttonContainer}>
        <Button
          ...
          onPress={handleRegisterRent}
          style={styles.button}
        />
        <Button
          title="Regresar al Usuario"
      ...
      {rentPricePerDay > 0 ? (
        <View style={styles.priceBubble}>
          <Text style={styles.priceText}>
            Precio por día: ${rentPricePerDay}
          </Text>
        </View>
      ) : null}
      {rentTotalPrice > 0 ? (
        <View style={styles.priceBubble}>
          <Text style={styles.priceText}>
            Precio total del alquiler: ${rentTotalPrice}
          </Text>
        </View>
      ) : null}
